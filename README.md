...
| View/Flag/Construct controls overlap the navbar or right sidebar | v0.9.2 lowers the action bar by one 42px navbar row. It reserves the sidebar's 210px width while the panel is open, then returns to true center when the sidebar is collapsed. |
